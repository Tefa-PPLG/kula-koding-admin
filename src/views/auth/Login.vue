<template>
  ...
  <form @submit.prevent="doLogin">
    <section>
      <div class="bg hidden lg:block">
        <div class="flex flex-col lg:w-screen lg:h-screen overflow-hidden text-white">
          <div class="flex-grow">
              ...
              <div
                ...
                <div class="m-5">
                  ...
                  <span class="flex flex-col gap-3">
                    ...
                    <button type="submit"
                      class="inline-flex mt-5 lg:mx-0 mx-auto justify-center items-center gap-1 font-semibold rounded-md dark:bg-[#FFAC0B] focus:bg-slate-300 border border-slate-900 hover:border-gray-400 dark:bg-transparent dark:focus:bg-slate-900 shadow p-2 hover:bg-slate-400 text-slate-900">
                      Login
                    </button>
                  </span>
                </div>
          ...
          <div class="flex flex-col flex-grow justify-between">
            <div class="flex flex-col justify-center items-center mt-20 text-white">
              ...
              <span class="flex flex-col gap-3">
                ...
                <button type="submit"
                  class="inline-flex mt-5 mx-0 justify-center items-center gap-1 font-semibold rounded-md bg-kuning focus:bg-slate-300 border border-slate-900 hover:border-gray-400 dark:bg-transparent dark:focus:bg-slate-900 dark:border-gray-600 hover:dark:border-gray-400 shadow p-2 hover:bg-slate-400 text-slate-900">
                  Login
                </button>
              </span>
            </div>
